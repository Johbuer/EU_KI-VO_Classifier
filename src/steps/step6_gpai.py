...
def render_step():
    ...
    if substep == 0:
        ...
        st.markdown(
            ...
            "gilt es als **Spezifisches KI-System auf Basis eines GPAI-Modells**."
        )

        current_mode = get_value("classification.gpai.system_restriction")
        
        opt_open = "Nein / Freitextfeld vorhanden: Das System kann faktisch weiterhin einer Vielzahl von Zwecken dienen (GPAI-System nach Art. 3 Nr. 66 KI-VO)."
        opt_restricted = "Ja, technisch eingeschränkt: Das System ist durch harte technische Schranken (z.B. ohne Freitextfeld) auf einen spezifischen Zweck verengt (Spezifisches KI-System)."
        ...
        if selected_opt == opt_open:
            ...
            info_box(
                "→ **Einstufung als Spezifisches KI-System auf GPAI-Basis**: Das System ist durch technische Schranken verengt. "
